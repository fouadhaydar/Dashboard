...
export const CustomModal = ({handleClose, open, handleAdd, selectedDate}:DataModale) => {
                        ...
                        {({
                            ...
                            <form onSubmit={handleSubmit}>
                                <TextField fullWidth
                                    ...
                                    helperText={ !!touched.content && !!errors.content && "the field is empty please enter ne event" }
                                    margin='normal'
                                />
                                <TextField 
                                    ...
                                    helperText={!!touched.endDate && !!errors.endDate && "the field is empty please enter ne event" }
                                    color='secondary'
                                />
