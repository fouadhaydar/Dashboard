...
const Invoices = () => {
    ...
    const { backgroundColorHeaderFooter ,backgroundColorAction, elementColor, elementColorOnHover } = myColors(theme.palette.mode)
    ...
    const coloums:GridColDef[] = [
        ...
        {field: "cost", headerName: "Cost", renderCell: (params) => <CustomCell title={`$${params.row.cost}`} myColor={elementColor}/>},
        ...
        {field: "date", headerName: "Date", renderCell: (params) => <CustomCell title={params.row.date} />},
    ]
